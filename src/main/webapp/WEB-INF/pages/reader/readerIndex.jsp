...
<div class="layuimini-container">
    <div class="layuimini-main">
        ...
        <!--Form, data retrieved from search is displayed here-->
    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'readerNumber', width: 150, title: 'Reader Number'},
                ...
                {title: 'Action', minWidth: 150, toolbar: '#currentTableBar', align: "center"}
            ]],
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'update') {  // 监听修改操作
                var index = layer.open({
                    title: 'Modify reader information',
                    type: 2,
                    shade: 0.2,
                    maxmin:true,
                    shadeClose: true,
