...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/lib/layui-v2.5.5/css/layui.css?v=1.2" media="all">
...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label required">Library card number</label>
        <div class="layui-input-block">
            <input type="text" name="readerNumber" lay-verify="required" lay-reqtext="The library card cannot be empty" placeholder="Please enter your library card" value="" class="layui-input">
        </div>
    </div>
